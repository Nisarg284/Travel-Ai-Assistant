...
/**
 * Local Expert Agent Tool — provides insider travel tips for Indian
 * destinations.
...
public class LocalExpertAgentTool {
  ...
  public String getLocalTips(
    ...
    String tips = LOCAL_TIPS.getOrDefault(key,
        "No specific local tips available for " + destination
            + ". General travel advice: carry cash, respect local customs, and try local food.");
